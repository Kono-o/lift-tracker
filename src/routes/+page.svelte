    ...
    try {
      ...
      if (info) {
        ...
        updateInfo = {
          ...
          downloadUrl: 'https://github.com/Kono-o/lift-tracker/releases/download/v1.1.0/lift-tracker-v1.1.0.apk',
          apiAssetUrl: 'https://github.com/Kono-o/lift-tracker/releases/download/v1.1.0/lift-tracker-v1.1.0.apk',
          size: 3620000,
          tag: 'v1.1.0'
        } as any;
      }
